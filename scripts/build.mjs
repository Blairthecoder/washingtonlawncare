...
const about = layout({
  ...
  content: `<section class="page-hero" data-mark="TW"><div class="wrap"><div class="breadcrumb"><a href="/">Home</a> / About</div><h1>Tyler Washington, Owner</h1><p>Washington Lawn Care & Service is owned and operated by Tyler Washington, providing hands-on property care throughout Lake Charles and Calcasieu Parish.</p></div></section>
...
const gallery = layout({
  ...
  pathName: '/gallery/',
  content: `<section class="page-hero" data-mark="WORK"><div class="wrap"><div class="breadcrumb"><a href="/">Home</a> / Gallery</div><h1>Project Gallery</h1><p>Real properties, real equipment and the finished details from jobs around Southwest Louisiana.</p></div></section><section class="section cream"><div class="wrap"><div class="gallery-grid">${galleryImages.map(([srcName, alt]) => `<figure data-reveal>${image(srcName, alt)}</figure>`).join('')}</div></div></section>`
});
...
const contact = layout({
  ...
  content: `<section class="page-hero" data-mark="CALL"><div class="wrap"><div class="breadcrumb"><a href="/">Home</a> / Free estimate</div><h1>Request a Free Estimate</h1><p>Call for the fastest response, or send the form with enough detail for us to understand the job.</p></div></section>
